function loadImage(imgPaths,docNames,specValues,doctorIDs)
{
    var images = imgPaths;
    var names = docNames;
    var specs = specValues;
    var imagePath_array=images.split(",");
    var name_array=names.split(",");
    var spec_array=specs.split(",");
    var doctorIDs_array=doctorIDs.split(",");
    //var imgArr=["../../images/1.gif","../../images/2.gif","../../images/3.gif","../../images/4.gif","../../images/5.gif","../../images/6.jpg"];
    var imgArr=imagePath_array;
    var ulobj=document.getElementById("mycarousel");
    var i;
    ...
    for(i=0;i<len;i++)
    {
        ...
        var specObj=document.createElement("label");
        var aObj=document.createElement("a");
        var liObj=document.createElement("li");
        var breakObj=document.createElement("br");
        var idObj=document.createElement("input");
        idObj.id="doc"+i;
        idObj.value = doctorIDs_array[i];
        idObj.type = 'hidden';
        nameObj.style.fontFamily="Arial,Helvetica,sans-serif";
        nameObj.style.fontSize="12px";
        nameObj.style.fontWeight="bold";
        nameObj.style.color="#0042A5";
        nameObj.innerHTML=name_array[i];
        specObj.style.fontFamily="Arial,Helvetica,sans-serif";
        specObj.style.fontSize="11px";        
        specObj.style.color="#0042A5";
        specObj.innerHTML=spec_array[i];
        imgObj.width=90;
        imgObj.height=90;
        imgObj.style.width=90;
        imgObj.style.height=90;
        imgObj.title="Click here to view profile";
        imgObj.src=imgArr[i];
        imgObj.style.border="1px solid #99ddff";
        aObj.href="javascript:getProfile('"+idObj.id+"')";
        aObj.style.textDecoration="none";
        aObj.appendChild(imgObj);
        aObj.appendChild(nameObj);
        aObj.appendChild(breakObj);
        aObj.appendChild(specObj);
        liObj.appendChild(aObj);  
        liObj.appendChild(idObj);
