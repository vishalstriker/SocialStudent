...
(function(d){
    ...
    _create:function(){
        ...
        this._isOpen=!1;
        a=(this.button=d('<button style="height:30px" type="button"><span class="ui-icon ui-icon-triangle-2-n-s"></span></button>')).addClass("ui-multiselect ui-widget ui-state-default ui-corner-all").addClass(b.classes).attr({
            title:a.attr("title"), 
            "aria-haspopup":!0,
